				...
				<div className='flex-1 p-8 mt-20'>
					<div className='container mx-auto px-4'>
						...
						<div className='grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8'>
							<div
								className='bg-white p-4 rounded-lg shadow-lg text-center border-2 border-green-600'
						...
						<div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-8'>
							{/* Daily Gains Chart */}
							<div
								className='bg-white p-6 rounded-lg shadow-lg text-center border-2 border-blue-600'
							...
							<div className='grid grid-cols-2 gap-4'>
								<div
									className='bg-white p-4 rounded-lg shadow-lg text-center border-2 border-yellow-600'
									style={{
								...
								<div
									className='bg-white p-4 rounded-lg shadow-lg text-center border-2 border-red-600'
									style={{
								...
								<div
									className='bg-white p-4 rounded-lg shadow-lg text-center border-2 border-purple-600 col-span-2'
						...
						<ul>
							<li className='mb-2'>
								<div
									...
									className='flex items-center space-x-2 p-3 rounded hover:bg-gray-800'>
									<FaHome />
									<span>Home</span>
									<span className='ml-auto bg-purple-600 text-xs rounded-full px-2 py-1'>
										12
									</span>
								</div>
							</li>
						...
						<ul>
							<li className='mb-2'>
								<div
									...
									className='flex items-center space-x-2 p-4 rounded hover:bg-gray-800'>
									<FaFileInvoice />
									<span>Invoices</span>
								</div>
							</li>
