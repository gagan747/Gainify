        ...
        <div className="py-12 md:py-20 border-t border-gray-800 flex flex-col lg:flex-row items-center">
          ...
          <div className="max-w-3xl mx-auto text-center lg:text-left lg:w-2/3 pb-12 md:pb-20">
            ...
            <p className="text-xl text-white">
              Gainify is a fund management company that excels in navigating
              financial markets to achieve outstanding returns. We combine
              expert strategies with financial education to help clients reach
              their financial goals and attain long-term success.
            </p>
          </div>
